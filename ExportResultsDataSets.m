...
extention = '*.TIF';
exprCFP = 'M20150416_w2CFP_s101_t(\d+).TIF';
exprYFP = 'M20150416_w1YFP_s101_t(\d+).TIF';
...
ExportResults(data_path,extention,exprCFP,exprYFP,resPath,resExt,resExp)
%% S102
...
data_path = fullfile('D:','DataFromJose','M20150416_p21_20X');
extention = '*.TIF';
exprCFP = 'M20150416_w2CFP_s102_t(\d+).TIF';

exprYFP = 'M20150416_w1YFP_s102_t(\d+).TIF';
...
data_path = fullfile('D:','DataFromJose','M20150416_p21_20X');
extention = '*.TIF';
exprCFP = 'M20150416_w2CFP_s103_t(\d+).TIF';
exprYFP = 'M20150416_w1YFP_s103_t(\d+).TIF';
...
data_path = fullfile('D:','DataFromJose','M20150416_p21_20X');
extention = '*.TIF';
exprCFP = 'M20150416_w2CFP_s104_t(\d+).TIF';
exprYFP = 'M20150416_w1YFP_s104_t(\d+).TIF';
...
data_path = fullfile('D:','DataFromJose','M20150416_p21_20X');
extention = '*.TIF';
exprCFP = 'M20150416_w2CFP_s105_t(\d+).TIF';
exprYFP = 'M20150416_w1YFP_s105_t(\d+).TIF';

resPath = fullfile('C:\Users\arbellea\Google Drive BGU\Cell_Tracking\Outputs','Results_LahavLab-Jose3_20X_s105_CheckPoints','Results'); 
